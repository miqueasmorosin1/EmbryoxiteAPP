...
def add_particles_bg():
    # Código HTML para incrustar partículas animadas
    particles_html = """
    ...
    #particles-js {
        ...
        height: 100%;
        z-index: -1;
        background-color: #0d47a1; /* Cambiar el color de fondo */
    }
    </style>
    ...
    """
    # Usar streamlit.components para incrustar HTML
    st.components.v1.html(particles_html, height=600)

# Configurar el diseño principal
st.set_page_config(page_title="Embryo Transfer Prioritization", layout="wide")

# Llamar al fondo de partículas
add_particles_bg()
threshold = 0.8
